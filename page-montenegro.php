		...
		<main id="main" class="site-main">
		  ...
		  <!-- <section class="way">
		    <div class="container">
		      ...
		      <div class="way-wrapper">
		        <div class="way-item">
		          <div class="way-item__img" style="background-image: url(<?php echo get_template_directory_uri()?>/img/psih_tyr_icon_1.svg)"></div>
		        ...
		        <div class="way-item">
		          <div class="way-item__img" style="background-image: url(<?php echo get_template_directory_uri()?>/img/psih_tyr_icon_2.svg)"></div>
		        ...
		        <div class="way-item">
		          <div class="way-item__img" style="background-image: url(<?php echo get_template_directory_uri()?>/img/psih_tyr_icon_3.svg)"></div>
		  ...
		  <section class="declaration">
		    <div class="container">
		      ...
		      <div class="btn-wrap">
		        <a href="#" class="button popup-modal" data-formid="Форма из блока Декларация курса Апгрэйд" data-mailmsg="Форма из блока Декларация курса Апгрэйд">Заказать участие в мастер классе</a>
		      </div>
		    </div>
		  </section>
		  <section class="about">
		  ...
		  <section class="advantages">
		    <div class="container">
		      ...
		      <div class="advantages-wrapper">
		        ...
		        <div class="advantages-item" style="background-image: url(<?php echo get_template_directory_uri()?>/img/psih_tyr_fot_3.jpg)">
		        ...
		        <div class="advantages-item" style="background-image: url(<?php echo get_template_directory_uri()?>/img/psih_tyr_fot_4.jpg)">
		  ...
		  <section class="programm" style="background-image: url(<?php echo get_template_directory_uri()?>/img/psih_tyr_fot_3.jpg)">
		    <div class="container">
		      ...
		      <div class="btn-wrap">
		        <a href="#" class="button popup-modal" data-formid="Форма из блока Программа тура" data-mailmsg="Форма из блока Программа тура">Заказать участие в Мастер классе</a>
		      </div>
		    </div>
		  </section>
				...
				<div class="packages-wrapper">
		  			...
		  			<div class="packages-item">
						...
						<?php echo carbon_get_the_post_meta("tpac2_prog");?>
		  				<a href="#" class="button popup-modal-3" data-program = "Мастеркласс - Перепрошивка" data-price = "27000" >Оплатить</a>
