...
?>
	...
	<div id="primary" class="content-area">
		<main id="main" class="site-main">
		    ...
		    <div class="container">
		      ...
		      <div class="way-wrapper">
		        <div class="way-item">
		          ...
		          <div class="way-item__title">Вам <br> не хватает...</div>
		          <div class="way-item__wrapper">
		            <div class="way-item__block">
		              <input id="way-1" type="checkbox">
		              <label for="way-1">Ощущения нужности</label>
		            </div>
		            <div class="way-item__block">
		              <input id="way-2" type="checkbox">
		              <label for="way-2">Уверенности в себе</label>
		            </div>
		            <div class="way-item__block">
		              <input id="way-3" type="checkbox">
		              <label for="way-3">Ощущения ценности</label>
		            </div>
		            <div class="way-item__block">
		              <input id="way-4" type="checkbox">
		              <label for="way-4">Принятия себя</label>
		            </div>
		            <div class="way-item__block">
		              <input id="way-5" type="checkbox">
		              <label for="way-5">Достоинства</label>
		            </div>
		            <div class="way-item__block">
		              <input id="way-6" type="checkbox">
		              <label for="way-6">Независимости</label>
		            </div>
		            <div class="way-item__block">
		              <input id="way-7" type="checkbox">
		              <label for="way-7">Удовлетворенности жизнью</label>
		            </div>
		            <div class="way-item__block">
		              <input id="way-8" type="checkbox">
		              <label for="way-8">Единства с собой любимой</label>
		            </div>
		            <div class="way-item__block">
		              <input id="way-9" type="checkbox">
		              <label for="way-9">Осознания своей миссии</label>
		            </div>
		            <div class="way-item__block">
		              <input id="way-10" type="checkbox">
		              <label for="way-10">Готовности к переменам</label>
		            </div>
		            <div class="way-item__block">
		              <input id="way-11" type="checkbox">
		              <label for="way-11">Ощущение свободы</label>
		            </div>
		          </div>
		        </div>
		        <div class="way-item">
		          <div class="way-item__img" style="background-image: url(<?php echo get_template_directory_uri()?>/img/Tyr_belorus_icon_2.svg)"></div>
		          <div class="way-item__title way-item__title-2">Вам постоянно<br> нужны...</div>
		          <div class="way-item__wrapper">
		            <div class="way-item__block">
		              <input id="way-12" type="checkbox">
		              <label for="way-12">Напоминания о том, какой вы хороший и добрый человек</label>
		            </div>
		            <div class="way-item__block">
		              <input id="way-13" type="checkbox">
		              <label for="way-13">Постоянные доказательства, что вас любят</label>
		            </div>
		            <div class="way-item__block">
		              <input id="way-14" type="checkbox">
		              <label for="way-14">Круглосуточные подтверждения, что вас ценят</label>
		            </div>
		            <div class="way-item__block">
		              <input id="way-15" type="checkbox">
		              <label for="way-15">Подсказки судьбы, людей, учителей, мужей и жён и т.д.</label>
		            </div>
		            <div class="way-item__block">
		              <input id="way-16" type="checkbox">
		              <label for="way-16">Помощь в поиске работы, второй половины и т.д.</label>
		            </div>
		          </div>
		        </div>
		        <div class="way-item">
		          <div class="way-item__img" style="background-image: url(<?php echo get_template_directory_uri()?>/img/Tyr_belorus_icon_3.svg)"></div>
		          <div class="way-item__title way-item__title-2">Вы обычно<br> испытываете:</div>
		          <div class="way-item__wrapper">
		            <div class="way-item__block">
		              <input id="way-17" type="checkbox">
		              <label for="way-17">Напряжение</label>
		            </div>
		            <div class="way-item__block">
		              <input id="way-18" type="checkbox">
		              <label for="way-18">Раздражительность</label>
		            </div>
		            <div class="way-item__block">
		              <input id="way-19" type="checkbox">
		              <label for="way-19">Уязвимость</label>
		            </div>
		            <div class="way-item__block">
		              <input id="way-20" type="checkbox">
		              <label for="way-20">Тревожность</label>
		            </div>
		            <div class="way-item__block">
		              <input id="way-21" type="checkbox">
		              <label for="way-21">Тревожность</label>
		            </div>
		            <div class="way-item__block">
		              <input id="way-22" type="checkbox">
		              <label for="way-22">Чувство вины</label>
		            </div>
		            <div class="way-item__block">
		              <input id="way-23" type="checkbox">
		              <label for="way-23">Чувство стыда</label>
		            </div>
		            <div class="way-item__block">
		              <input id="way-24" type="checkbox">
		              <label for="way-24">Высокомерие</label>
		            </div>
		            <div class="way-item__block">
		              <input id="way-25" type="checkbox">
		              <label for="way-25">Обиду</label>
		            </div>
		            <div class="way-item__block">
		              <input id="way-26" type="checkbox">
		              <label for="way-26">Злость</label>
		            </div>
		            <div class="way-item__block">
		              <input id="way-27" type="checkbox">
		              <label for="way-27">Ревность</label>
		            </div>
		            <div class="way-item__block">
		              <input id="way-28" type="checkbox">
		              <label for="way-28">Боль</label>
		            </div>
		          </div>
		        </div>
		      </div>
		      ...
		      <div class="about-content">
		        ...
		        <div class="about-content__text">
		          ...
		          <p>Психотерапевт, Сексолог, Специалист по семейной психотерапии, гипнотерапевт.</p>
					-->
					<?php
						echo apply_filters('the_content', carbon_get_the_post_meta("competention"));
					?>
				</div>
		      ...
		      <div class="about-content">
		        ...
		        <div class="about-content__text">
		          ...
		          <p>Психотерапевт, Сексолог, Специалист по семейной психотерапии, гипнотерапевт.</p>
					-->
					<?php
						echo apply_filters('the_content', carbon_get_the_post_meta("competention2"));
					?>
				</div>
		      ...
		      <div class="advantages-wrapper">
		        <div class="advantages-item" style="background-image: url(<?php echo get_template_directory_uri()?>/img/shodhan.jpg)">
		          ...
		          <div class="advantages-item__content">
		            ...
		            <div class="advantages-item__text">
		              <?php echo carbon_get_the_post_meta("p1_txt");?>
		            </div>
		          </div>
		        </div>
		        <div class="advantages-item" style="background-image: url(<?php echo get_template_directory_uri()?>/img/board.jpg)">
		          ...
		          <div class="advantages-item__content">
		            ...
		            <div class="advantages-item__text">
		              <?php echo carbon_get_the_post_meta("p2_txt");?>
		            </div>
		          </div>
		        </div>
		        <div class="advantages-item" style="background-image: url(<?php echo get_template_directory_uri()?>/img/acrila.jpg)">
		          ...
		          <div class="advantages-item__content">
		            ...
		            <div class="advantages-item__text">
		              <?php echo carbon_get_the_post_meta("p3_txt");?>
		            </div>
		          </div>
		        </div>
		      </div>
		  ...
		  <section class="programm" style="background-image: url(<?php echo get_template_directory_uri()?>/img/psih_tyr_fot_bel_3_ban.jpg)">
		    <div class="container">
 ...
 -->		        <!-- <div class="programm-item">
		      ...
		      <div class="btn-wrap">
		        <a href="#" class="button popup-modal"  data-winmsg = "Участвовать в Мастер Классе" data-formid="Форма из блока Программа тура" data-mailmsg="Форма из блока Программа тура" data-winmsg = "Участвовать в Мастер Классе">Заказать участие в Мастер классе</a>
		      </div>
		    </div>
		  </section>
		  <section class="accommodation">
		    <div class="container">
		      ...
		      <div class="accommodaion-wrapper">
		        ...
		        <!-- <div class="accommodation-item">
		          <h4 class="accommodation-item__title tt-u"><?php echo carbon_get_the_post_meta("hotel_pz");?></h4>
		          <span class="accommodation-item__descr"><?php echo carbon_get_the_post_meta("hotel_text_down");?></span>
		          <div class="accommodation-item__photo-wrapper">
		            <img class="accommodation-item__photo-little" src="<?php echo wp_get_attachment_image_src(carbon_get_the_post_meta('hotel_img_2'), 'full')[0];?>" alt="">
		            <img class="accommodation-item__photo-little" src="<?php echo wp_get_attachment_image_src(carbon_get_the_post_meta('hotel_img_3'), 'full')[0];?>" alt="">
		          </div>
		        </div> -->
		      </div>
		      <div class="btn-wrap">
		  		...
		  		<div class="packages-wrapper packages-wrapper__boards">
		  			...
		  			<div class="packages-item">
						...
						<?php echo carbon_get_the_post_meta("tpac2_prog");?>
		  				<a href="#" class="button popup-modal-3" data-formid="Заказ пакета участия <?php echo carbon_get_the_post_meta("tpac2_data");?>" data-mailmsg="Заказ пакета участия <?php echo carbon_get_the_post_meta("tpac2_data");?>" data-winmsg = "Заказать пакет <?php echo carbon_get_the_post_meta("tpac2_data");?>">Оплатить</a>
		      ...
		      <div class="questions-form">
		        <form action="" class="main-form">
		          ...
		          <div class="way-item__block">
		            ...
		            <label for="policy-input">Я согласен на <a href="<?php echo get_permalink(3)?>" class="tdu">обработку персональных данных</a> и с договором оферты</label>
		          </div>
		        </form>
		      </div>
		    </div>
